...
import { House, ChartColumn, CalendarClock, BookOpen, UsersRound, ChevronDown,ShoppingBag } from "lucide-react";
      ...
      <div className="flex-shrink-0 flex items-center space-x-2">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-white shadow-md">
            ...
            <DropdownMenuItem>
              <button onClick={() => console.log("Logout")} className="w-full text-left">
                Logout
              </button>
            </DropdownMenuItem>
          </DropdownMenuContent>
